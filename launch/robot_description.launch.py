...
def generate_launch_description():
    ...
    robot_state_publisher_node = Node(
        ...
        parameters=[
            {"robot_description": Command(["xacro ", description_path, " SENSORS:=", LaunchConfiguration("SENSORS")])},  # The robot's URDF description, generated by processing the Xacro file.
